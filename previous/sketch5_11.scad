...
difference() 
{
    ...
    //translate([0,-1,16]) rotate([-90,90,0]) cylinder(d=9.5,h=20,$fn=6); // upper trim
    translate([0,-1,0]) rotate([-90,90,0]) cylinder(d=9.5,h=20,$fn=6); // lower trim
    translate([-1,0,7]) rotate([0,90,0]) cylinder(d=4,h=20,$fn=6); // upper trim
}
}
...
//  (control signal)
translate([-8,-4,22]) rotate([0,90,0])
{
    difference() 
    {
...
//// in the sketch5_11pressplate.scad:
...
translate([10-3,-37,-7])
        difference()
        {
        translate( [0,-8,0] ) cube( [3,25+2*8,9.5] );
        translate([1.1,-4,4.5]) 
            rotate([0,90,0])
                    translate([0,0,-2]) cylinder( d=4, h=5, $fn=12 ); // 3mm screw
        translate([1.1,25+4,4.5]) 
...
translate([-10,-37-3-8,-7])
    cube([20,3,9.5]);
translate([-7,-37-3-8,0])
    difference()
    {
        union()
        {
            cube([2,3,8]);
            translate([4,0,0]) cube([2,3,8]);
            translate([8,0,0]) cube([2,3,8]);
            translate([12,0,0]) cube([2,3,8]);
        }
        translate([-1,0,5])rotate([0,90,0]) cylinder(d=3,h=16,$fn=6); // holes
    }
